 ...
 */
final class Version20231004000854 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE compagnie (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, siret VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE sous_compagnie (id INT AUTO_INCREMENT NOT NULL, compagnie_id INT NOT NULL, type VARCHAR(255) NOT NULL, INDEX IDX_B96BE22752FBE437 (compagnie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE sous_compagnie ADD CONSTRAINT FK_B96BE22752FBE437 FOREIGN KEY (compagnie_id) REFERENCES compagnie (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sous_compagnie DROP FOREIGN KEY FK_B96BE22752FBE437');
        ...
        $this->addSql('DROP TABLE sous_compagnie');
